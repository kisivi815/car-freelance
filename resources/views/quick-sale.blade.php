                                        ...
                                        <form class="form form-horizontal" method="POST" action="{{ route('submit-quick-sales') }}" name="quickSaleForm">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="salesPersonName" class="salesPersonName form-control" name="SalesPersonName" oninput="removeNumbers(this)" placeholder="Sales Person Name">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="customerName" class="customerName form-control" name="CustomerName" oninput="removeNumbers(this)" placeholder="Customer Name">
                                                    </div>
